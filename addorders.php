...
<div id="signup" class="tm-page-content">
            ...
            4%;margin-top: 2%;">
              <form action="orders.php" method="POST" id="contact-form">
                ...
                <div class="tm-form-group">
                  <input type="address" id="address" name="address" class="tm-form-control" placeholder="address" required />
                </div>       
                <div>
                  <button class="btn btn-lg btn-warning btn-block" type="submit" name="submit" style="margin-top: 1%;">Order</button>
                  </div>
              </form>
            </div>
          </div>
