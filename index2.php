...
<body>
  ...
  <div class="tm-container">
          ...
          <nav class="tm-site-nav">
            <ul class="tm-site-nav-ul">
              ...
              <li class="tm-page-nav-item">
                ...
                <li class="tm-page-nav-item">
                <a href="contactus.php" class="tm-page-lin" style="min-width: 240px;
    height: 100px;
    ...
    font-size: 1.2rem;">
                ...
                <li class="tm-page-nav-item">
                <a href="logout.php" class="tm-page-lin" style="min-width: 240px;
    height: 100px;
    background-color: white;
    color: #099;
    display: flex;
...
<div id="cold" class="tm-tab-content">
              ...
              <div class="tm-list">
                ...
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    ...
                    <p class="tm-list-item-description">It takes only 2 to 4 minutes to cook! There’s really nothing faster on the grill, and it makes for a simple, healthy dinner.</p> <a href="addorders.php">Order</a>                 
                  </div>
                </div>
                <div class="tm-list-item">          
            ...
            <div class="tm-special-items">
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h3 class="tm-list-item-name">Secret Item 1 <br>
                  </h3><span class="tm-list-item-price">$10.25</span>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h3 class="tm-list-item-name">Secret Item 2 <br>
                  </h3><span class="tm-list-item-price">$10.25</span>
                  <p class="tm-special-item-text"></p>  
                  <a href="addorders.php">Order</a>
                </div>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h3 class="tm-list-item-name">Secret Item 3 <br>
                  </h3><span class="tm-list-item-price">$10.25</span>
                  <p class="tm-special-item-text"></p>  
                  <a href="addorders.php">Order</a>  
                </div>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h3 class="tm-list-item-name">Secret Item 4 <br>
                  </h3><span class="tm-list-item-price">$10.25</span>
                  <p class="tm-special-item-text"></p>  
                  <a href="addorders.php">Order</a>
                </div>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h3 class="tm-list-item-name">Secret Item 5 <br>
                  </h3><span class="tm-list-item-price">$10.25</span>
                  <p class="tm-special-item-text"></p>  
                  <a href="addorders.php">Order</a>
                </div>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h3 class="tm-list-item-name">Secret Item 6 <br>
                  </h3><span class="tm-list-item-price">$10.25</span>
                  <p class="tm-special-item-text"></p>  
                  <a href="addorders.php">Order</a>
                </div>
  ...
  <div id="login" class="tm-page-content" style="margin-right:17%;width: 50%;">
    ...
    <!-- Contact Page -->
          <div id="contact" class="tm-page-content" style="margin-right:17%;width: 50%;">
            <div class="tm-black-bg tm-contact-form-container tm-align-right">
              <form action="contact=uslogic.php" method="POST" id="contact-form">
                <div class="tm-form-group">
 ...
 <!-- Sign Up Page -->
            ...
            <div class="tm-black-bg tm-contact-form-container tm-align-right">
              <form action="add.php" method="POST" id="contact-form">
                <div class="tm-form-group">
